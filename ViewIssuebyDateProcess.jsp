...
<html>
  <head>
    ...
    <title>My JSP 'ViewIssuebyDateProcess.jsp' starting page</title>
  ...
  <body  onresize="ReSzNav(),checkLogo()" onload="resolvePanel(),checkLogo()">
	...
	<a href="ViewIssuebyDate.jsp"><button class="btn btn-danger btn-lg active">Back</button></a><br/>
   ...
   try
   {
	...
	String query="select * from returnrecord where issuedate like ? order by issuedate desc";
