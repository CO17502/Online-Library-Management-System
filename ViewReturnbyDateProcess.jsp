...
<html>
  <head>
    ...
    <title>My JSP 'ViewReturnbyDateProcess.jsp' starting page</title>
  ...
  <body  onresize="ReSzNav(),checkLogo()" onload="resolvePanel(),checkLogo()">
	...
	<center><h1 id="pageName" style="color: red;">Books Issued</h1></center>
	
	<a href="ViewReturnbyDate.jsp"><button class="btn btn-danger btn-lg active">Back</button></a><br/>
   ...
   try
   {
	...
	String query="select * from returnrecord where returndate like ? order by issuedate desc";
