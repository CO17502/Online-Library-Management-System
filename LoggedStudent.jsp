...
<html>
  <head>
    ...
    <title>CCET | Chandigarh | Student</title>
  ...
  <script>
  	function option1(){document.getElementById('option').src="SearchStudent.jsp";}
  	function option2(){document.getElementById('option').src="ViewPersonalReq.jsp";}
  	function option3(){document.getElementById('option').src="ViewPersonalissue.jsp";}
  	function option4(){document.getElementById('option').src="ViewPersonalPending.jsp";}
  	function option5(){document.getElementById('option').src="ViewProfile.jsp";}
  </script>
  </head>
...
<div id="HdNav" onclick="comNav()"></div>
        <div class="NvBrCnt" id="NvBrCnt">
            <ul class="NvBr">
                ...
                <li class="NvBrRt">
                    <a href="LogOut2.jsp"><span class="glyphicon glyphicon-log-out"></span> LogOut</a>
                </li>
                <li class="NvBrRt">
...
<div class="vertical-menu" style="display: inline-block;">
    ...
    <br/>
    <h4><a class="btn btn-primary"  onclick="option2()"><b>View All Requests(To be issued)</b></a></h4>
    <br/>
    <h4><a class="btn btn-primary"  onclick="option3()"><b>View Previously Issued Books</b></a></h4>
    <br/>
    <h4><a class="btn btn-primary"  onclick="option4()"><b>View Books to be returned</b></a></h4>
    <br/>
    <h4><a class="btn btn-primary"  onclick="option5()"><b>View Profile</b></a></h4>
    <br/>
    <br/><br/>
</div>

	
	<div style="display: inline-block; width: 78%; margin-bottom: 20px; overflow-x:scroll;"><iframe id="option" src="" height=70% width=100% frameborder="1" ></iframe></div>
